"""Tests for UCBQPolicy (formerly MCTSPolicy) in tmnf/policies.py."""
...
from games.tmnf.policies import UCBQPolicy, WeightedLinearPolicy, _action_to_idx, _discretize_obs
...
class TestUCBQPolicy(unittest.TestCase):
    ...
    def test_update_changes_q_value(self):
        p = UCBQPolicy(alpha=1.0, gamma=0.0)
        obs = _zero_obs()
